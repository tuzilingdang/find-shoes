...
public class Users extends AbstractUsers implements java.io.Serializable {
	...
	/** minimal constructor */
    public Users(String userId, String password, String nick, Double balance, String ip, String vip, String defunct) {
        super(userId, password, nick, balance, ip, vip, defunct);        
    }
