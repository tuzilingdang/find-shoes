...
public class ArticleDAO extends BaseHibernateDAO {
	...
	public Article findById(java.lang.Integer id) {
		...
		try {
			Article instance = (Article) getSession().get("com.model.Article",
					id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Article instance) {
		...
		try {
			List results = getSession().createCriteria("com.model.Article")
	...
	public List findByDefunct(Object defunct) {
		//System.out.println("Object defunct == "+defunct);
