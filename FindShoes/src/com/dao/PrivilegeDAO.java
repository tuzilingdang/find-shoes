...
/**
	 ...
	 * @see com.model.Privilege
  * @author MyEclipse Persistence Tools 
 */

public class PrivilegeDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(PrivilegeDAO.class);
		//property constants
    ...
    public Privilege findById( com.model.PrivilegeId id) {
        ...
        try {
            Privilege instance = (Privilege) getSession()
                    .get("com.model.Privilege", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public Privilege merge(Privilege detachedInstance) {
        ...
        try {
            Privilege result = (Privilege) getSession()
